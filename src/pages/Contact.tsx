...
export function Contact() {
  ...
  function handleSubmit(e: FormEvent) {
    ...
    // Client-only success until a server route (e.g. Resend, DB) is wired — see docs/technical-plan.md
    setSubmitted(true)
    setForm(initialForm)
    setErrors({})
  }
      ...
      <main id="main-content" className="contact-main">
        <header className="contact-intro">
          ...
          <p className="contact-lede">
            Use this form for <strong>partnerships</strong>, <strong>pilots</strong>,{' '}
            <strong>press</strong>, <strong>technical questions</strong>, or general feedback. We
            aim to reply within <strong>a few business days</strong>.
          </p>
          <p className="contact-note">
            For life-threatening emergencies, use your <strong>local emergency number</strong>.
            FESTR is not a substitute for official dispatch.
          </p>
        </header>
        ...
        {submitted && (
          <div className="contact-success" role="status" aria-live="polite">
            ...
            <p className="contact-success__text">
              We’ll get back to you when we can. If your matter is urgent and operational, say so in
              the subject line next time.
            </p>
            <button
              type="button"
          ...
          >
            ...
            <div className="contact-field">
              ...
              <select
                ...
                value={form.topic}
                onChange={(e) =>
                  setForm((f) => ({ ...f, topic: e.target.value as TopicValue }))
                }
            ...
            <div className="contact-field contact-field--checkbox">
              <label className="contact-checkbox">
                ...
                />
                <span>
                  I understand how my data is used — see the{' '}
        ...
        <section className="contact-faq" aria-labelledby="contact-faq-heading">
          ...
          <dl className="contact-faq__list">
            <div>
              <dt>Pilots</dt>
              <dd>
                Choose <strong>Pilot / program</strong> or <strong>Partnership</strong> and describe
                your organization and geography. We’ll follow up by email.
              </dd>
            </div>
            <div>
              <dt>Data &amp; privacy</dt>
              <dd>
                Read the <Link to="/privacy">Privacy</Link> page. Until a backend is connected, this
                form only confirms on screen — wire to secure storage or email when ready.
              </dd>
            </div>
            <div>
              <dt>Emergencies</dt>
              <dd>
                Do not use this form for emergencies. Use official emergency numbers and local
                services.
              </dd>
            </div>
          </dl>
